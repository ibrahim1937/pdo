<div class="row justify-content-center">
                        ...
                        <form class="classeform">
                                <div class="form-group nopad">
                                    <h2 id ="class-section-header">Chercher classe par filiere</h2>
                                </div>
                                <div class="container">
                                        <div class="form-group fcontainer">
                                        ...
                                        <div class="form-group hide classecontainer">
                                            <label for="classeinput">Classe</label>
                                            <input type="text" class="form-control" id="classeinput">
                                            <div class="justify-content-center">
                                                <button type="button" class="btn btn-success ajouter" id="btn_ajax">Modifier</button>
                                            </div>
                                        </div>
                                </div>
                        </form>
